      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        <motion.div
          ...
          style={{
            ...
            left: "5%",
            background:
              "linear-gradient(135deg, var(--primary) 0%, rgba(147, 51, 234, 1) 50%, rgba(236, 72, 153, 1) 100%)",
            filter: "blur(80px)",
        ...
        <motion.div
          ...
          style={{
            ...
            right: "10%",
            background:
              "linear-gradient(225deg, rgba(236, 72, 153, 1) 0%, rgba(167, 139, 250, 1) 50%, rgba(99, 102, 241, 1) 100%)",
            filter: "blur(70px)",
            transform: "translate3d(0, 0, 0)",
          }}
        />
        ...
        <motion.div
          ...
          style={{
            ...
            left: "10%",
            background:
              "linear-gradient(45deg, rgba(45, 212, 191, 1) 0%, rgba(56, 189, 248, 1) 50%, rgba(124, 58, 237, 1) 100%)",
            filter: "blur(75px)",
            transform: "translate3d(0, 0, 0)",
          }}
        />
        ...
        <motion.div
          ...
          style={{
            ...
            right: "5%",
            background:
              "linear-gradient(315deg, rgba(139, 92, 246, 1) 0%, rgba(192, 132, 252, 1) 50%, rgba(244, 114, 182, 1) 100%)",
            filter: "blur(65px)",
            transform: "translate3d(0, 0, 0)",
          }}
        />
          ...
          <div className="space-y-6 sm:space-y-8 md:space-y-12">
            ...
            >
              <div className="relative space-y-3 sm:space-y-4">
                ...
                <div className="flex items-center justify-center gap-2 sm:gap-3">
                  ...
                  >
                    Product Manager & Full Stack Developer & UI/UX Designer
                  </motion.p>
                  <motion.div
                    className="h-[1px] w-8 sm:w-12 bg-gradient-to-r from-transparent via-primary/30 to-transparent"
                    initial={{ width: 0 }}
            ...
            >
              {[
                ...
                {
                  href: "https://twitter.com/wangenius314",
                ...
                <motion.div
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  <SocialButton href={social.href} icon={social.icon} />
                </motion.div>
              ))}
            </motion.div>
