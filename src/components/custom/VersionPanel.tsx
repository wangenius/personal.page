          ...
          {slides.map((slide, index) => (
            <CarouselItem key={index}>
              ...
              >
                {/* 背景渐变 */}
                <div
                  className={cn("absolute inset-0 bg-gradient-to-br opacity-50", slide.gradient)}
                />
                ...
                <div className="absolute inset-0">
                  <div
                    className="absolute w-[500px] h-[500px] -right-48 -top-48 rounded-full bg-primary/20 blur-[80px]"
                  />
                  <div
                    className="absolute w-[300px] h-[300px] -left-32 -bottom-32 rounded-full bg-primary/10 blur-[60px]"
                  />
                </div>
