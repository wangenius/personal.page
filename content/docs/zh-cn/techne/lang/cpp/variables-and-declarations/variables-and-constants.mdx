...
<Callout type="success" title="个人理解">
...
<Callout type="success" title="全局变量和全局静态变量的区别">
...
<Callout type="success" title="只读变量和常量的区别">
...
<Callout type="success" title="const 常量的判别准则">
...
<Callout type="success" title="const 引用的类型与初始化变量的类型">
* 相同：初始化变量成为只读变量
* 不同：生成一个新的只读变量
</Callout>
